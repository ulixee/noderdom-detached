...
import { IGlobalEventHandlersEventMap, IAddEventListenerOptions, IEventListenerOrEventListenerObject, IEventListenerOptions, IHTMLParamElement } from '../interfaces';
import HTMLElement, { IHTMLElementRps, rpHTMLElementKeys } from './HTMLElement';

export default class HTMLParamElement extends HTMLElement implements IHTMLParamElement {
  public get name(): string {
    return InternalHandler.get<HTMLParamElement, string>(this, 'name');
  }

  public set name(value: string) {
    InternalHandler.set<HTMLParamElement, string>(this, 'name', value);
  }

  public get type(): string {
    return InternalHandler.get<HTMLParamElement, string>(this, 'type');
  }

  public set type(value: string) {
    InternalHandler.set<HTMLParamElement, string>(this, 'type', value);
  }

  public get value(): string {
    return InternalHandler.get<HTMLParamElement, string>(this, 'value');
  }

  public set value(value: string) {
    InternalHandler.set<HTMLParamElement, string>(this, 'value', value);
  }

  public get valueType(): string {
    return InternalHandler.get<HTMLParamElement, string>(this, 'valueType');
  }

  public set valueType(value: string) {
    InternalHandler.set<HTMLParamElement, string>(this, 'valueType', value);
  }
  ...
  public addEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IAddEventListenerOptions): void {
    InternalHandler.run<HTMLParamElement, void>(this, 'addEventListener', [type, listener, options]);
  }
  ...
  public removeEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IEventListenerOptions): void {
    InternalHandler.run<HTMLParamElement, void>(this, 'removeEventListener', [type, listener, options]);
  }
}
