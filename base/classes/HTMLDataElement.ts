...
export default class HTMLDataElement extends HTMLElement implements IHTMLDataElement {
  public get value(): string {
    return InternalHandler.get<HTMLDataElement, string>(this, 'value');
  }

  public set value(value: string) {
    InternalHandler.set<HTMLDataElement, string>(this, 'value', value);
  }
  ...
  public addEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IAddEventListenerOptions): void {
    InternalHandler.run<HTMLDataElement, void>(this, 'addEventListener', [type, listener, options]);
  }
  ...
  public removeEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IEventListenerOptions): void {
    InternalHandler.run<HTMLDataElement, void>(this, 'removeEventListener', [type, listener, options]);
  }
}
