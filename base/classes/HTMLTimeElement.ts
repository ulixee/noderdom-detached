...
import { IGlobalEventHandlersEventMap, IAddEventListenerOptions, IEventListenerOrEventListenerObject, IEventListenerOptions, IHTMLTimeElement } from '../interfaces';
import HTMLElement, { IHTMLElementRps, rpHTMLElementKeys } from './HTMLElement';

export default class HTMLTimeElement extends HTMLElement implements IHTMLTimeElement {
  public get dateTime(): string {
    return InternalHandler.get<HTMLTimeElement, string>(this, 'dateTime');
  }

  public set dateTime(value: string) {
    InternalHandler.set<HTMLTimeElement, string>(this, 'dateTime', value);
  }
  ...
  public addEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IAddEventListenerOptions): void {
    InternalHandler.run<HTMLTimeElement, void>(this, 'addEventListener', [type, listener, options]);
  }
  ...
  public removeEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IEventListenerOptions): void {
    InternalHandler.run<HTMLTimeElement, void>(this, 'removeEventListener', [type, listener, options]);
  }
}
