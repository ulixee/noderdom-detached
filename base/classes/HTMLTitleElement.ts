...
import { IGlobalEventHandlersEventMap, IAddEventListenerOptions, IEventListenerOrEventListenerObject, IEventListenerOptions, IHTMLTitleElement } from '../interfaces';
import HTMLElement, { IHTMLElementRps, rpHTMLElementKeys } from './HTMLElement';

export default class HTMLTitleElement extends HTMLElement implements IHTMLTitleElement {
  public get text(): string {
    return InternalHandler.get<HTMLTitleElement, string>(this, 'text');
  }

  public set text(value: string) {
    InternalHandler.set<HTMLTitleElement, string>(this, 'text', value);
  }
  ...
  public addEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IAddEventListenerOptions): void {
    InternalHandler.run<HTMLTitleElement, void>(this, 'addEventListener', [type, listener, options]);
  }
  ...
  public removeEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IEventListenerOptions): void {
    InternalHandler.run<HTMLTitleElement, void>(this, 'removeEventListener', [type, listener, options]);
  }
}
