...
import { ITextTrackListEventMap, IAddEventListenerOptions, IEventListenerOrEventListenerObject, IEventListenerOptions, ITextTrack, IEvent, ITextTrackList } from '../interfaces';
...
export default class TextTrackList extends EventTarget implements ITextTrackList {
  ...
  public get length(): number {
    return InternalHandler.get<TextTrackList, number>(this, 'length');
  }

  public get onaddtrack(): ((this: ITextTrackList, ev: IEvent) => any) | null {
    return InternalHandler.get<TextTrackList, ((this: ITextTrackList, ev: IEvent) => any) | null>(this, 'onaddtrack');
  }

  public set onaddtrack(value: ((this: ITextTrackList, ev: IEvent) => any) | null) {
    InternalHandler.set<TextTrackList, ((this: ITextTrackList, ev: IEvent) => any) | null>(this, 'onaddtrack', value);
  }

  public get onchange(): ((this: ITextTrackList, ev: IEvent) => any) | null {
    return InternalHandler.get<TextTrackList, ((this: ITextTrackList, ev: IEvent) => any) | null>(this, 'onchange');
  }

  public set onchange(value: ((this: ITextTrackList, ev: IEvent) => any) | null) {
    InternalHandler.set<TextTrackList, ((this: ITextTrackList, ev: IEvent) => any) | null>(this, 'onchange', value);
  }

  public get onremovetrack(): ((this: ITextTrackList, ev: IEvent) => any) | null {
    return InternalHandler.get<TextTrackList, ((this: ITextTrackList, ev: IEvent) => any) | null>(this, 'onremovetrack');
  }

  public set onremovetrack(value: ((this: ITextTrackList, ev: IEvent) => any) | null) {
    InternalHandler.set<TextTrackList, ((this: ITextTrackList, ev: IEvent) => any) | null>(this, 'onremovetrack', value);
  }

  // methods

  public getTrackById(id: string): ITextTrack | null {
    return InternalHandler.run<TextTrackList, ITextTrack | null>(this, 'getTrackById', [id]);
  }
  ...
  public addEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IAddEventListenerOptions): void {
    InternalHandler.run<TextTrackList, void>(this, 'addEventListener', [type, listener, options]);
  }
  ...
  public removeEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IEventListenerOptions): void {
    InternalHandler.run<TextTrackList, void>(this, 'removeEventListener', [type, listener, options]);
  }
