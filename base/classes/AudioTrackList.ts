...
export default class AudioTrackList extends EventTarget implements IAudioTrackList {
  ...
  public get length(): number {
    return InternalHandler.get<AudioTrackList, number>(this, 'length');
  }

  public get onaddtrack(): ((this: IAudioTrackList, ev: IEvent) => any) | null {
    return InternalHandler.get<AudioTrackList, ((this: IAudioTrackList, ev: IEvent) => any) | null>(this, 'onaddtrack');
  }

  public set onaddtrack(value: ((this: IAudioTrackList, ev: IEvent) => any) | null) {
    InternalHandler.set<AudioTrackList, ((this: IAudioTrackList, ev: IEvent) => any) | null>(this, 'onaddtrack', value);
  }

  public get onchange(): ((this: IAudioTrackList, ev: IEvent) => any) | null {
    return InternalHandler.get<AudioTrackList, ((this: IAudioTrackList, ev: IEvent) => any) | null>(this, 'onchange');
  }

  public set onchange(value: ((this: IAudioTrackList, ev: IEvent) => any) | null) {
    InternalHandler.set<AudioTrackList, ((this: IAudioTrackList, ev: IEvent) => any) | null>(this, 'onchange', value);
  }

  public get onremovetrack(): ((this: IAudioTrackList, ev: IEvent) => any) | null {
    return InternalHandler.get<AudioTrackList, ((this: IAudioTrackList, ev: IEvent) => any) | null>(this, 'onremovetrack');
  }

  public set onremovetrack(value: ((this: IAudioTrackList, ev: IEvent) => any) | null) {
    InternalHandler.set<AudioTrackList, ((this: IAudioTrackList, ev: IEvent) => any) | null>(this, 'onremovetrack', value);
  }

  // methods

  public getTrackById(id: string): IAudioTrack | null {
    return InternalHandler.run<AudioTrackList, IAudioTrack | null>(this, 'getTrackById', [id]);
  }
  ...
  public addEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IAddEventListenerOptions): void {
    InternalHandler.run<AudioTrackList, void>(this, 'addEventListener', [type, listener, options]);
  }
  ...
  public removeEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IEventListenerOptions): void {
    InternalHandler.run<AudioTrackList, void>(this, 'removeEventListener', [type, listener, options]);
  }
