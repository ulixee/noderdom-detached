...
import { IGlobalEventHandlersEventMap, IAddEventListenerOptions, IEventListenerOrEventListenerObject, IEventListenerOptions, IAssignedNodesOptions, INode, IElement, IHTMLSlotElement } from '../interfaces';
import HTMLElement, { IHTMLElementRps, rpHTMLElementKeys } from './HTMLElement';

export default class HTMLSlotElement extends HTMLElement implements IHTMLSlotElement {
  public get name(): string {
    return InternalHandler.get<HTMLSlotElement, string>(this, 'name');
  }

  public set name(value: string) {
    InternalHandler.set<HTMLSlotElement, string>(this, 'name', value);
  }

  // methods

  public assignedElements(options?: IAssignedNodesOptions): Iterable<IElement> {
    return InternalHandler.run<HTMLSlotElement, Iterable<IElement>>(this, 'assignedElements', [options]);
  }

  public assignedNodes(options?: IAssignedNodesOptions): Iterable<INode> {
    return InternalHandler.run<HTMLSlotElement, Iterable<INode>>(this, 'assignedNodes', [options]);
  }
  ...
  public addEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IAddEventListenerOptions): void {
    InternalHandler.run<HTMLSlotElement, void>(this, 'addEventListener', [type, listener, options]);
  }
  ...
  public removeEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IEventListenerOptions): void {
    InternalHandler.run<HTMLSlotElement, void>(this, 'removeEventListener', [type, listener, options]);
  }
}
