...
export default class Node extends EventTarget implements INode {
  ...
  public get baseURI(): string {
    return InternalHandler.get<Node, string>(this, 'baseURI');
  }

  public get childNodes(): INodeList {
    return InternalHandler.get<Node, INodeList>(this, 'childNodes');
  }

  public get firstChild(): INode | null {
    return InternalHandler.get<Node, INode | null>(this, 'firstChild');
  }

  public get isConnected(): boolean {
    return InternalHandler.get<Node, boolean>(this, 'isConnected');
  }

  public get lastChild(): INode | null {
    return InternalHandler.get<Node, INode | null>(this, 'lastChild');
  }

  public get nextSibling(): INode | null {
    return InternalHandler.get<Node, INode | null>(this, 'nextSibling');
  }

  public get nodeName(): string {
    return InternalHandler.get<Node, string>(this, 'nodeName');
  }

  public get nodeType(): number {
    return InternalHandler.get<Node, number>(this, 'nodeType');
  }

  public get nodeValue(): string | null {
    return InternalHandler.get<Node, string | null>(this, 'nodeValue');
  }

  public set nodeValue(value: string | null) {
    InternalHandler.set<Node, string | null>(this, 'nodeValue', value);
  }

  public get ownerDocument(): IDocument | null {
    return InternalHandler.get<Node, IDocument | null>(this, 'ownerDocument');
  }

  public get parentElement(): IElement | null {
    return InternalHandler.get<Node, IElement | null>(this, 'parentElement');
  }

  public get parentNode(): INode | null {
    return InternalHandler.get<Node, INode | null>(this, 'parentNode');
  }

  public get previousSibling(): INode | null {
    return InternalHandler.get<Node, INode | null>(this, 'previousSibling');
  }

  public get textContent(): string | null {
    return InternalHandler.get<Node, string | null>(this, 'textContent');
  }

  public set textContent(value: string | null) {
    InternalHandler.set<Node, string | null>(this, 'textContent', value);
  }

  // methods

  public appendChild(node: INode): INode {
    return InternalHandler.run<Node, INode>(this, 'appendChild', [node]);
  }

  public cloneNode(deep?: boolean): INode {
    return InternalHandler.run<Node, INode>(this, 'cloneNode', [deep]);
  }

  public compareDocumentPosition(other: INode): number {
    return InternalHandler.run<Node, number>(this, 'compareDocumentPosition', [other]);
  }

  public contains(other: INode | null): boolean {
    return InternalHandler.run<Node, boolean>(this, 'contains', [other]);
  }

  public getRootNode(options?: IGetRootNodeOptions): INode {
    return InternalHandler.run<Node, INode>(this, 'getRootNode', [options]);
  }

  public hasChildNodes(): boolean {
    return InternalHandler.run<Node, boolean>(this, 'hasChildNodes', []);
  }

  public insertBefore(node: INode, child: INode | null): INode {
    return InternalHandler.run<Node, INode>(this, 'insertBefore', [node, child]);
  }

  public isDefaultNamespace(namespace: string | null): boolean {
    return InternalHandler.run<Node, boolean>(this, 'isDefaultNamespace', [namespace]);
  }

  public isEqualNode(otherNode: INode | null): boolean {
    return InternalHandler.run<Node, boolean>(this, 'isEqualNode', [otherNode]);
  }

  public isSameNode(otherNode: INode | null): boolean {
    return InternalHandler.run<Node, boolean>(this, 'isSameNode', [otherNode]);
  }

  public lookupNamespaceURI(prefix: string | null): string | null {
    return InternalHandler.run<Node, string | null>(this, 'lookupNamespaceURI', [prefix]);
  }

  public lookupPrefix(namespace: string | null): string | null {
    return InternalHandler.run<Node, string | null>(this, 'lookupPrefix', [namespace]);
  }

  public normalize(): void {
    InternalHandler.run<Node, void>(this, 'normalize', []);
  }

  public removeChild(child: INode): INode {
    return InternalHandler.run<Node, INode>(this, 'removeChild', [child]);
  }

  public replaceChild(node: INode, child: INode): INode {
    return InternalHandler.run<Node, INode>(this, 'replaceChild', [node, child]);
  }
}
