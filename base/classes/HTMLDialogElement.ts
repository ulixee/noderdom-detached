...
export default class HTMLDialogElement extends HTMLElement implements IHTMLDialogElement {
  public get open(): boolean {
    return InternalHandler.get<HTMLDialogElement, boolean>(this, 'open');
  }

  public set open(value: boolean) {
    InternalHandler.set<HTMLDialogElement, boolean>(this, 'open', value);
  }
  ...
  public addEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IAddEventListenerOptions): void {
    InternalHandler.run<HTMLDialogElement, void>(this, 'addEventListener', [type, listener, options]);
  }
  ...
  public removeEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IEventListenerOptions): void {
    InternalHandler.run<HTMLDialogElement, void>(this, 'removeEventListener', [type, listener, options]);
  }
}
