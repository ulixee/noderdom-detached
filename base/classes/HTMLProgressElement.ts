...
import { IGlobalEventHandlersEventMap, IAddEventListenerOptions, IEventListenerOrEventListenerObject, IEventListenerOptions, INodeList, IHTMLProgressElement } from '../interfaces';
...
export default class HTMLProgressElement extends HTMLElement implements IHTMLProgressElement {
  ...
  public get labels(): INodeList {
    return InternalHandler.get<HTMLProgressElement, INodeList>(this, 'labels');
  }

  public get max(): number {
    return InternalHandler.get<HTMLProgressElement, number>(this, 'max');
  }

  public set max(value: number) {
    InternalHandler.set<HTMLProgressElement, number>(this, 'max', value);
  }

  public get position(): number {
    return InternalHandler.get<HTMLProgressElement, number>(this, 'position');
  }

  public get value(): number {
    return InternalHandler.get<HTMLProgressElement, number>(this, 'value');
  }

  public set value(value: number) {
    InternalHandler.set<HTMLProgressElement, number>(this, 'value', value);
  }
  ...
  public addEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IAddEventListenerOptions): void {
    InternalHandler.run<HTMLProgressElement, void>(this, 'addEventListener', [type, listener, options]);
  }
  ...
  public removeEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IEventListenerOptions): void {
    InternalHandler.run<HTMLProgressElement, void>(this, 'removeEventListener', [type, listener, options]);
  }
}
