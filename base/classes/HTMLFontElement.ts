...
export default class HTMLFontElement extends HTMLElement implements IHTMLFontElement {
  public get color(): string {
    return InternalHandler.get<HTMLFontElement, string>(this, 'color');
  }

  public set color(value: string) {
    InternalHandler.set<HTMLFontElement, string>(this, 'color', value);
  }

  public get face(): string {
    return InternalHandler.get<HTMLFontElement, string>(this, 'face');
  }

  public set face(value: string) {
    InternalHandler.set<HTMLFontElement, string>(this, 'face', value);
  }

  public get size(): string {
    return InternalHandler.get<HTMLFontElement, string>(this, 'size');
  }

  public set size(value: string) {
    InternalHandler.set<HTMLFontElement, string>(this, 'size', value);
  }
  ...
  public addEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IAddEventListenerOptions): void {
    InternalHandler.run<HTMLFontElement, void>(this, 'addEventListener', [type, listener, options]);
  }
  ...
  public removeEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IEventListenerOptions): void {
    InternalHandler.run<HTMLFontElement, void>(this, 'removeEventListener', [type, listener, options]);
  }
}
