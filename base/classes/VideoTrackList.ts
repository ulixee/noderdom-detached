...
import { IVideoTrackListEventMap, IAddEventListenerOptions, IEventListenerOrEventListenerObject, IEventListenerOptions, IVideoTrack, IEvent, IVideoTrackList } from '../interfaces';
...
export default class VideoTrackList extends EventTarget implements IVideoTrackList {
  ...
  public get length(): number {
    return InternalHandler.get<VideoTrackList, number>(this, 'length');
  }

  public get onaddtrack(): ((this: IVideoTrackList, ev: IEvent) => any) | null {
    return InternalHandler.get<VideoTrackList, ((this: IVideoTrackList, ev: IEvent) => any) | null>(this, 'onaddtrack');
  }

  public set onaddtrack(value: ((this: IVideoTrackList, ev: IEvent) => any) | null) {
    InternalHandler.set<VideoTrackList, ((this: IVideoTrackList, ev: IEvent) => any) | null>(this, 'onaddtrack', value);
  }

  public get onchange(): ((this: IVideoTrackList, ev: IEvent) => any) | null {
    return InternalHandler.get<VideoTrackList, ((this: IVideoTrackList, ev: IEvent) => any) | null>(this, 'onchange');
  }

  public set onchange(value: ((this: IVideoTrackList, ev: IEvent) => any) | null) {
    InternalHandler.set<VideoTrackList, ((this: IVideoTrackList, ev: IEvent) => any) | null>(this, 'onchange', value);
  }

  public get onremovetrack(): ((this: IVideoTrackList, ev: IEvent) => any) | null {
    return InternalHandler.get<VideoTrackList, ((this: IVideoTrackList, ev: IEvent) => any) | null>(this, 'onremovetrack');
  }

  public set onremovetrack(value: ((this: IVideoTrackList, ev: IEvent) => any) | null) {
    InternalHandler.set<VideoTrackList, ((this: IVideoTrackList, ev: IEvent) => any) | null>(this, 'onremovetrack', value);
  }

  public get selectedIndex(): number {
    return InternalHandler.get<VideoTrackList, number>(this, 'selectedIndex');
  }

  // methods

  public getTrackById(id: string): IVideoTrack | null {
    return InternalHandler.run<VideoTrackList, IVideoTrack | null>(this, 'getTrackById', [id]);
  }
  ...
  public addEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IAddEventListenerOptions): void {
    InternalHandler.run<VideoTrackList, void>(this, 'addEventListener', [type, listener, options]);
  }
  ...
  public removeEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IEventListenerOptions): void {
    InternalHandler.run<VideoTrackList, void>(this, 'removeEventListener', [type, listener, options]);
  }
