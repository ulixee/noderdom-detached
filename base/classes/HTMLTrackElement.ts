...
import { IGlobalEventHandlersEventMap, IAddEventListenerOptions, IEventListenerOrEventListenerObject, IEventListenerOptions, IHTMLTrackElement } from '../interfaces';
...
export default class HTMLTrackElement extends HTMLElement implements IHTMLTrackElement {
  ...
  public get default(): boolean {
    return InternalHandler.get<HTMLTrackElement, boolean>(this, 'default');
  }

  public set default(value: boolean) {
    InternalHandler.set<HTMLTrackElement, boolean>(this, 'default', value);
  }

  public get kind(): string {
    return InternalHandler.get<HTMLTrackElement, string>(this, 'kind');
  }

  public set kind(value: string) {
    InternalHandler.set<HTMLTrackElement, string>(this, 'kind', value);
  }

  public get label(): string {
    return InternalHandler.get<HTMLTrackElement, string>(this, 'label');
  }

  public set label(value: string) {
    InternalHandler.set<HTMLTrackElement, string>(this, 'label', value);
  }

  public get readyState(): number {
    return InternalHandler.get<HTMLTrackElement, number>(this, 'readyState');
  }

  public get src(): string {
    return InternalHandler.get<HTMLTrackElement, string>(this, 'src');
  }

  public set src(value: string) {
    InternalHandler.set<HTMLTrackElement, string>(this, 'src', value);
  }

  public get srclang(): string {
    return InternalHandler.get<HTMLTrackElement, string>(this, 'srclang');
  }

  public set srclang(value: string) {
    InternalHandler.set<HTMLTrackElement, string>(this, 'srclang', value);
  }
  ...
  public addEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IAddEventListenerOptions): void {
    InternalHandler.run<HTMLTrackElement, void>(this, 'addEventListener', [type, listener, options]);
  }
  ...
  public removeEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IEventListenerOptions): void {
    InternalHandler.run<HTMLTrackElement, void>(this, 'removeEventListener', [type, listener, options]);
  }
}
