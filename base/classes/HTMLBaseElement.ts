...
export default class HTMLBaseElement extends HTMLElement implements IHTMLBaseElement {
  public get href(): string {
    return InternalHandler.get<HTMLBaseElement, string>(this, 'href');
  }

  public set href(value: string) {
    InternalHandler.set<HTMLBaseElement, string>(this, 'href', value);
  }

  public get target(): string {
    return InternalHandler.get<HTMLBaseElement, string>(this, 'target');
  }

  public set target(value: string) {
    InternalHandler.set<HTMLBaseElement, string>(this, 'target', value);
  }
  ...
  public addEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IAddEventListenerOptions): void {
    InternalHandler.run<HTMLBaseElement, void>(this, 'addEventListener', [type, listener, options]);
  }
  ...
  public removeEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IEventListenerOptions): void {
    InternalHandler.run<HTMLBaseElement, void>(this, 'removeEventListener', [type, listener, options]);
  }
}
