...
export default class HTMLCanvasElement extends HTMLElement implements IHTMLCanvasElement {
  public get height(): number {
    return InternalHandler.get<HTMLCanvasElement, number>(this, 'height');
  }

  public set height(value: number) {
    InternalHandler.set<HTMLCanvasElement, number>(this, 'height', value);
  }

  public get width(): number {
    return InternalHandler.get<HTMLCanvasElement, number>(this, 'width');
  }

  public set width(value: number) {
    InternalHandler.set<HTMLCanvasElement, number>(this, 'width', value);
  }

  // methods

  public getContext(contextId: string, ...args: any[]): IRenderingContext | null {
    return InternalHandler.run<HTMLCanvasElement, IRenderingContext | null>(this, 'getContext', [contextId, args]);
  }

  public toBlob(callback: IBlobCallback, type?: string, quality?: any): void {
    InternalHandler.run<HTMLCanvasElement, void>(this, 'toBlob', [callback, type, quality]);
  }

  public toDataURL(type?: string, quality?: any): string {
    return InternalHandler.run<HTMLCanvasElement, string>(this, 'toDataURL', [type, quality]);
  }
  ...
  public addEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IAddEventListenerOptions): void {
    InternalHandler.run<HTMLCanvasElement, void>(this, 'addEventListener', [type, listener, options]);
  }
  ...
  public removeEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IEventListenerOptions): void {
    InternalHandler.run<HTMLCanvasElement, void>(this, 'removeEventListener', [type, listener, options]);
  }
}
