...
export default class Attr extends Node implements IAttr {
  ...
  public get localName(): string {
    return InternalHandler.get<Attr, string>(this, 'localName');
  }

  public get name(): string {
    return InternalHandler.get<Attr, string>(this, 'name');
  }

  public get namespaceURI(): string | null {
    return InternalHandler.get<Attr, string | null>(this, 'namespaceURI');
  }

  public get ownerElement(): IElement | null {
    return InternalHandler.get<Attr, IElement | null>(this, 'ownerElement');
  }

  public get prefix(): string | null {
    return InternalHandler.get<Attr, string | null>(this, 'prefix');
  }

  public get specified(): boolean {
    return InternalHandler.get<Attr, boolean>(this, 'specified');
  }

  public get value(): string {
    return InternalHandler.get<Attr, string>(this, 'value');
  }

  public set value(value: string) {
    InternalHandler.set<Attr, string>(this, 'value', value);
  }
}
