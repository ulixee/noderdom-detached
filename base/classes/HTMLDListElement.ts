...
export default class HTMLDListElement extends HTMLElement implements IHTMLDListElement {
  public get compact(): boolean {
    return InternalHandler.get<HTMLDListElement, boolean>(this, 'compact');
  }

  public set compact(value: boolean) {
    InternalHandler.set<HTMLDListElement, boolean>(this, 'compact', value);
  }
  ...
  public addEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IAddEventListenerOptions): void {
    InternalHandler.run<HTMLDListElement, void>(this, 'addEventListener', [type, listener, options]);
  }
  ...
  public removeEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IEventListenerOptions): void {
    InternalHandler.run<HTMLDListElement, void>(this, 'removeEventListener', [type, listener, options]);
  }
}
