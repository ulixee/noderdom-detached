...
import { ISVGSVGElementEventMap, IAddEventListenerOptions, IEventListenerOrEventListenerObject, IEventListenerOptions, ISVGNumber, IElement, ISVGSVGElement } from '../interfaces';
...
export default class SVGSVGElement extends SVGSVGElementBase implements ISVGSVGElement {
  public createSVGNumber(): ISVGNumber {
    return InternalHandler.run<SVGSVGElement, ISVGNumber>(this, 'createSVGNumber', []);
  }

  public forceRedraw(): void {
    InternalHandler.run<SVGSVGElement, void>(this, 'forceRedraw', []);
  }

  public getElementById(elementId: string): IElement {
    return InternalHandler.run<SVGSVGElement, IElement>(this, 'getElementById', [elementId]);
  }

  public suspendRedraw(maxWaitMilliseconds: number): number {
    return InternalHandler.run<SVGSVGElement, number>(this, 'suspendRedraw', [maxWaitMilliseconds]);
  }

  public unsuspendRedraw(suspendHandleID: number): void {
    InternalHandler.run<SVGSVGElement, void>(this, 'unsuspendRedraw', [suspendHandleID]);
  }

  public unsuspendRedrawAll(): void {
    InternalHandler.run<SVGSVGElement, void>(this, 'unsuspendRedrawAll', []);
  }
  ...
  public addEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IAddEventListenerOptions): void {
    InternalHandler.run<SVGSVGElement, void>(this, 'addEventListener', [type, listener, options]);
  }
  ...
  public removeEventListener(type: string, listener: IEventListenerOrEventListenerObject, options?: boolean | IEventListenerOptions): void {
    InternalHandler.run<SVGSVGElement, void>(this, 'removeEventListener', [type, listener, options]);
  }
}
