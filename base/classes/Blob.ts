...
export default class Blob implements IBlob {
  ...
  public get size(): number {
    return InternalHandler.get<Blob, number>(this, 'size');
  }

  public get type(): string {
    return InternalHandler.get<Blob, string>(this, 'type');
  }

  // methods

  public slice(start?: number, end?: number, contentType?: string): IBlob {
    return InternalHandler.run<Blob, IBlob>(this, 'slice', [start, end, contentType]);
  }
}
