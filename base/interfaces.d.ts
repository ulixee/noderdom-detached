...
export declare type ITextTrackKind = 'captions' | 'chapters' | 'descriptions' | 'metadata' | 'subtitles';
export declare type ITextTrackMode = 'disabled' | 'hidden' | 'showing';
export declare type IVisibilityState = 'hidden' | 'prerender' | 'visible';
export declare type IEventListenerOrEventListenerObject = IEventListener | IEventListenerObject;
export declare type IUnsupportedFeature = void;
export declare type ICanvasRenderingContext2D = IUnsupportedFeature;
export declare type IWebGLRenderingContext = IUnsupportedFeature;
export declare type IWindowProxy = IUnsupportedFeature;
export declare type IBufferSource = ArrayBufferView | ArrayBuffer;
export declare type IBlobPart = IBufferSource | IBlob | string;
export declare type IRenderingContext = ICanvasRenderingContext2D | IWebGLRenderingContext;
...
export declare type IBlobCallback = (blob: IBlob | null) => void;
export declare type IEventListener = (evt: IEvent) => void;
export declare type INodeFilter = ((node: INode) => number) | {
