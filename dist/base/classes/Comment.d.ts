...
export declare const getState: (instance: IComment) => any, setState: <P = ICommentProperties>(instance: IComment, properties: P) => void, setHiddenState: <IHiddenProperties extends {}>(instance: IComment, properties: IHiddenProperties) => void, setReadonlyOfComment: (instance: IComment, properties: ICommentReadonlyProperties) => void;
export declare const internalHandler: InternalHandler<IComment>;
export declare function CommentGenerator(CharacterData: Constructable<ICharacterData>): {
...
export declare const CommentPropertyKeys: string[];
export declare const CommentConstantKeys: string[];
