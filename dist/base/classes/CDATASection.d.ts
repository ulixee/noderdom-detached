...
export declare const getState: (instance: ICDATASection) => any, setState: <P = ICDATASectionProperties>(instance: ICDATASection, properties: P) => void, setHiddenState: <IHiddenProperties extends {}>(instance: ICDATASection, properties: IHiddenProperties) => void, setReadonlyOfCDATASection: (instance: ICDATASection, properties: ICDATASectionReadonlyProperties) => void;
export declare const internalHandler: InternalHandler<ICDATASection>;
export declare function CDATASectionGenerator(Text: Constructable<IText>): {
    new (): {
...
export declare const CDATASectionPropertyKeys: string[];
export declare const CDATASectionConstantKeys: string[];
