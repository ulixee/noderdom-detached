...
declare const CDATASection_base: {
    new (): {
        readonly wholeText: string;
        splitText(offset: number): import("../../base/interfaces").IText;
        data: string;
...
export default class CDATASection extends CDATASection_base implements ICDATASection {
    constructor();
}
export {};
