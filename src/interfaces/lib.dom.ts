...
// * All modified lines are flagged with MODIFIED.
// * All interfaces imported into interfaces/index.ts were prefixed with "export".
// * When necessary, depreciated vars/methods were set to "optional".
...
// MODIFIED: stop from extending Node
...
export interface NodeFilter {
  // MODIFIED: Added constants to interface
